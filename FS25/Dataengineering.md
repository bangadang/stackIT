...
- priority comparison: nodes with high priorities can be selected primary. primary has highest priority score
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc2MzYyNTc3MSwtMTkwOTgyMzc2LC03Nj
