...
Der Term Cov(X,Y) beschreibt den linearen Zusammenhang der beiden Zufallsvariablen. Er ist nur in Ausnahmefällen gleich null, z.B.  wenn X und Y unabhängig sind.
Achtung Var(X-Y)=Var (X ) + Var (Y ) = Var (X + Y )
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzA2NzE2NDA5LDI2ODA4MTAzMSwtMTk5NT
