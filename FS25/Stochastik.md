...
$$f^Y(y) = \frac{d}{dy}F^Y(y)$$$$=\frac{d}{dy}F^X(g^{-1}(y))$$$$=\frac{d}{d(g^{-1}(y))}F^X(g^{-1}(y))\cdot\frac{d}{dy}g^{-1}(y)\text{ || Verkettungsregel}$$$$f^X(g^{-1}(y))$$


<!--stackedit_data:
eyJoaXN0b3J5IjpbNzI1NDYyNjc1LC0xMDM5OTU5OTIwLDE0Nz
