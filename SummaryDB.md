...
- **Schlüssel**
	...
	- **Fremdschlüssel** (Foreign-Key): Eine Menge von Attributen einer Relation S(B_1, .. B_n) zu denen es eine Relation R gibt, welche einen Primärschlüssel hat, der diese Attribute von S

> Written with [StackEdit](https://stackedit.io/).
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MTgxMDQ4MCwtNDk5NTYzNDFdfQ==
-->