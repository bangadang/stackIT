...
- **Stripchart** 
	- Daten werden als Box/Punkt auf einer Linie aufgetragen: Datenpunkte mit gleichem Wert treten nur einmal auf. Um solche Datenpunkte sichtbar zu machen gibt es zwei Möglichkeiten, in dem Man die Punkte/Boxen verschiebt oder stapelt.
		...
		- stacked Stripchart
- **Histogramm**
	- Ziel des Histogramm ist die Verteilung der Datenpunkte über einen Wertebereich darzustellen. Umgesetzt wird das indem man Daten gruppiert
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQ5Nzc3ODc2OSwtMTk1MDQ1NzQwMiwtMj
